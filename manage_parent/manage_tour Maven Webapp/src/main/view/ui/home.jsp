						...
						<ul class="nofitications-dropdown">
							<li class="dropdown">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-envelope"></i><span class="badge">3</span></a>
										...
										<ul class="dropdown-menu">
											...
											<li><a href="#">
											   <div class="user_img"><img src="statics/images/1.png" alt=""></div>
							...
							<li class="login_box" id="loginContainer">
									<div class="search-box">
										...
										<script src="statics/js/uisearch.js"></script>
											<script>
							...
							<li class="dropdown profile_details_drop">
								<a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
									<div class="profile_img">	
										<span style="background:url(statics/images/1.jpg) no-repeat center"> </span> 
										 <div class="user-name">
		...
		<div class="switches">
			<div class="col-4">
				...
				<div class="col-md-4 switch-right">
					...
					<div class="sparkline">
						<!--graph-->
						<link rel="stylesheet" href="statics/css/graph.css"/>
				...
				<div class="activity_box">
					...
					<div class="scrollbar scrollbar1" id="style-2">
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src='statics/images/1.png' class="img-responsive" alt=""/></div>
						...
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src='statics/images/5.png' class="img-responsive" alt=""/></div>
							<div class="col-xs-7 activity-desc">
						...
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src='statics/images/3.png' class="img-responsive" alt=""/></div>
							<div class="col-xs-7 activity-desc">
						...
						<div class="activity-row">
							<div class="col-xs-3 activity-img"><img src='statics/images/4.png' class="img-responsive" alt=""/></div>
							<div class="col-xs-7 activity-desc">
				...
				<div class="activity_box activity_box1">
					...
					<div class="scrollbar" id="style-2">
						<div class="activity-row activity-row1">
							<div class="col-xs-3 activity-img"><img src='statics/images/1.png' class="img-responsive" alt=""/><span>10:00 PM</span></div>
						...
						<div class="activity-row activity-row1">
							...
							<div class="col-xs-3 activity-img"><img src='statics/images/3.png' class="img-responsive" alt=""/><span>10:02 PM</span></div>
							<div class="clearfix"> </div>
						</div>
						<div class="activity-row activity-row1">
							<div class="col-xs-3 activity-img"><img src='statics/images/1.png' class="img-responsive" alt=""/><span>10:00 PM</span></div>
